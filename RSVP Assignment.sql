...
SELECT 
    COUNT(*) AS title_null_count
FROM
    movie
WHERE title IS NULL;

SELECT 
    COUNT(*) AS year_null_count
FROM
    movie
WHERE year IS NULL;

SELECT 
    COUNT(*) AS date_null_count
FROM
    movie
WHERE date_published IS NULL;

SELECT 
    COUNT(*) AS duration_null_count
FROM
    movie
WHERE duration IS NULL;

SELECT 
    COUNT(*) AS country_null_count
FROM
    movie
WHERE country IS NULL;

SELECT 
    COUNT(*) AS worlwide_gross_income_null_count
FROM
    movie
WHERE worlwide_gross_income IS NULL;

SELECT 
    COUNT(*) AS languages_null_count
FROM
    movie
WHERE languages IS NULL;

SELECT 
    COUNT(*) AS production_company_null_count
FROM
    movie
